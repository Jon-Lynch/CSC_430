...
class PlotViewer:
    'class serving as the view/controller for Plot Generator classes'
    def registerPlotGenerator(self, spg):                             # create method registerPlotGenerator that accepts an argument
        self.spg = spg                                                # initialize self.spg
        self.spg.registerPlotViewer(self)                             # register self.spg
    def queryUser(self, str):                                         # create method queryUser that accepts a string argument
        return input(str)                                             # return input
    def generate(self):                                               # create method generate
        print(self.spg.generate())                                    # print plot generated
